...
const (
	VersionService_GetVersion_FullMethodName = "/main.VersionService/GetVersion"
)
...
func (c *versionServiceClient) GetVersion(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*VersionResponse, error) {
...
func (UnimplementedVersionServiceServer) GetVersion(context.Context, *emptypb.Empty) (*VersionResponse, error) {
...
var VersionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "main.VersionService",
